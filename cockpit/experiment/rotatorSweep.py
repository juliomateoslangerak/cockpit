...
class ExperimentUI(wx.Panel):
    ...
    def saveSettings(self, settings=None):
        ...
        cockpit.util.userConfig.setValue(
            self.configKey + "RotatorSweepExperimentSettings", settings
        )
